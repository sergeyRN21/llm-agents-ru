---
name: core-agent
description: Core agent capabilities including TODO management, file operations, and subagent delegation
license: MIT
allowed-tools: ls read_file write_file write_todos read_todos task think_tool get_current_datetime
---
